const { addWorkoutPlan, deleteWorkoutPlan, parameterizedSearch, getWorkoutPlan, getWorkoutPlanByTrainer, fetchCreatedWorkoutPlan, updateWorkoutPlan, like, dislike } = require('../controllers/workoutplan');
